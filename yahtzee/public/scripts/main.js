...
rhit.YahtzeeController = class {
    constructor() {
        ...
        document.querySelector("#rollButton").onclick = () => {
            this.game.roll();
            this.updateView();
        };

        document.querySelector("#newRoundButton").onclick = () => {
            this.game = new rhit.YahtzeeRound();
            this.updateView();
        };
    ...
    updateView() {
        ...
        diceElements.forEach((dieImage, index) => {
            ...
            console.log("Current die", this.game.getDieValueAtIndex(index),this.game.getDieStateAtIndex(index));
            ...
            if(this.game.roundState == rhit.YahtzeeRound.RoundState.ROUND_COMPLETE) {
                document.querySelector("#rollButtonColumn").style.display = "none";
            } else {
                document.querySelector("#rollButtonColumn").style.display = "block";
            }
        });
    }
}
